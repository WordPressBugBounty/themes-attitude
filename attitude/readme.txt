...
* Update - fontawesome updated to version 6.6
* Update - social profiles logo images replaced with fontawesome
* Update - twitter logo updated and threads social profile option added
...
= 4.0.3 =
* Fix - Slogan bar width issue on previous version fixed
