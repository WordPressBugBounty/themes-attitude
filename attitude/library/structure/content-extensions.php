            ...
            <?php if (has_category() !=''){?>
  			...
  			<div class="entry-meta-bar clearfix">	        			
    			<div class="entry-meta">
    				<span class="by-author vcard author"><span class="fn"><?php _e( 'By', 'attitude' ); ?> <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php echo esc_html( get_the_author() ); ?></a></span></span> |
