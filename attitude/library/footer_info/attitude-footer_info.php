...
function attitude_wp_link() {
   return '<a href="'.esc_url( 'http://wordpress.org' ).'" target="_blank" rel="noopener noreferrer" title="' . esc_attr__( 'WordPress', 'attitude' ) . '"><span>' . __( 'WordPress', 'attitude' ) . '</span></a>';
}
/**
...
function attitude_themehorse_link() {
   return '<a href="'.esc_url( 'http://themehorse.com' ).'" target="_blank" rel="noopener noreferrer" title="'.esc_attr__( 'Theme Horse', 'attitude' ).'" ><span>'.__( 'Theme Horse', 'attitude') .'</span></a>';
}
/**
